...
public class SongInfoFragment extends Fragment implements View.OnClickListener, Runnable{

    final static String ARG_POSITION = "position";
    int mCurrentPosition = -1;
    private Button btnPlay, btnPause, btnReset;
    private final String DEBUG_TAG = "com.cmw2993.lockhaven.edu";
    private MediaPlayer mediaPlayer = null;
    private SeekBar seekBar, seek;
    ...
    public void updateArticleView(int position) {
        ...
        text.setText(Database.Names[position]);
        View view = getView();
        view.setBackgroundResource(Database.Headlines[position]);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.button_play:
                ...
                new Thread(SongInfoFragment.this).start();
                break;
